...
print("\n" + "="*50)
print(f"{'Métrica':<25} {'Verbalized':>12}")
print("-"*50)

for m in metrics:
    b = scores_verbalized[m]
    print(f"{m:<25} {b:>12.3f}")
...
summary_df.to_csv("evaluation_summary_verbalized_Table.csv", index=False, encoding="utf-8")
print("\nSummary saved to evaluation_summary_verbalized_Table.csv")
